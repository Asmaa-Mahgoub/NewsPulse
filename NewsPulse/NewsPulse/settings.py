"""
Django settings for NewsPulse project.
...
SECRET_KEY = 'django-insecure-kzqgxx6r5hnnrvr2xe*g)3jxpwijbozfvtcty!gz6db@utlh$='
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # if JWT auth
    ]
}
...
WSGI_APPLICATION = 'NewsPulse.wsgi.application'
